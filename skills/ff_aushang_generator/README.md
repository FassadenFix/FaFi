...
Generiert standortspezifische Mieterinformationen und Aushänge. Verwenden für: Eingabe von Projektdaten (Ort, Datum, Ansprechpartner), Auswahl von Textbausteinen, PDF-Generierung.
...
```
/ff-aushang-generator
"Mit Ff Aushang Generator erstellen"
```
...
```
--no-ff-aushang-generator
--skip-ff-aushang-generator
"ohne Ff Aushang Generator"
```
