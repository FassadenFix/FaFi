<div align="center">
  ...
  **Verwaltet und automatisiert den Onboarding-Prozess fuer neue Mitarbeiter**
...
Verwaltet und automatisiert den Onboarding-Prozess fuer neue Mitarbeiter. Verwenden für: Checklisten-Workflow (17 Punkte), Dokumenten-Sammlung, Statusverfolgung, automatische Erinnerungen.
...
```
/ff-hr-onboarding
"Mit Ff Hr Onboarding erstellen"
```
...
```
--no-ff-hr-onboarding
--skip-ff-hr-onboarding
"ohne Ff Hr Onboarding"
```
